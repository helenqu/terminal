...
function process_cd(directory) {
	if (current_dir === "~") {
		switch (directory) {
			case "about":
				$("#output").append("<p id='about'>i'm currently a junior studying computer science at the university of pennsylvania. i appreciate minimalist design, quaint coffee shops, and baking reality shows much more than i should.</p>");
				$("#output").append("<p>-------------------------------------------------</p>");
